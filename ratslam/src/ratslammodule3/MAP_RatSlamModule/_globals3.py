...
VTRANS_IMAGE_X_MIN = 80
VTRANS_IMAGE_X_MAX = 560
VTRANS_IMAGE_Y_MIN = 240
VTRANS_IMAGE_Y_MAX = 360

# These four parameters allow the specification of the cropping region for rotational velocity
VROT_IMAGE_X_MIN   = 80
VROT_IMAGE_X_MAX   = 560
VROT_IMAGE_Y_MIN   = 120
VROT_IMAGE_Y_MAX   = 360
...
IMAGE_VT_X_RANGE_MIN = 80
IMAGE_VT_X_RANGE_MAX = 560
IMAGE_VT_Y_RANGE_MIN = 60
IMAGE_VT_Y_RANGE_MAX = 420
