...
class PoseCellNetwork(object):
    ...
    def __init__(self):
        ...
        '''
        self.best_th, self.best_y, self.best_x = [PC_DIM_TH / 2, PC_DIM_XY / 2, PC_DIM_XY / 2]
    ...
    def __excite__(self):
        ...
        for k,j,i in zip( *index ): # Change Python 3 - Paulo
    ...
    def __path_integration__(self, vtrans, vrot):
        ...
        for dir_pc in range( PC_DIM_TH ): # Change Python 3 - Paulo
    ...
    def save(self):
        ...
        Outputs: -
        '''
        with open('./Save/posecellvisual_templates.txt', 'w+') as file: # Paulo
        ...
        with open('./Save/posecellexperiences.txt', 'w+') as file: # Paulo
    ...
    def load(self):
        ...
        Outputs: -
        '''
        with open('./Save/posecellvisual_templates.txt', 'r') as file:
            line = file.readline()
            while line != "-\n":
                id = float(line)
                line = file.readline()
        ...
        with open('./Save/posecellexperiences.txt', 'r') as file:
            line = file.readline()
            while line != "-\n":
                x_pc = float(line)
                line = file.readline()
