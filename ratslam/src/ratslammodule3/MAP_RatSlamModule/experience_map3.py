...
from .utils import * # Change Python 3 - Paulo
...
class ExperienceMap(object):
    ...
    def save(self):
        ...
        Outputs: -
        '''
        with open('./Save/experiences.txt', 'w') as file:
        ...
        with open('./Save/links.txt', 'w') as file:
        ...
        with open('./Save/goal_list.txt', 'w') as file:
    ...
    def load(self):
        ...
        Outputs: -
        '''
        with open('./Save/experiences.txt', 'r') as file:
            line = file.readline()
            while line != "-\n":
                id = float(line)
                line = file.readline()
        ...
        with open('./Save/links.txt', 'r') as file:
            line = file.readline()
            while line != '':
                d = float(line)
                line = file.readline()
                ...
                self.links = np.append(self.links, new_link)
        with open('./Save/goal_list.txt', 'r') as file:
            line = file.readline()
    ...
    def prune(self, vt_size):
            ...
            delexps = -delexps
            print(delexps) # Change Python 3 - Paulo
            for i in delexps:
    ...
    def merge_experiences(self, exps):
            ...
            for exp in exps:
                print (exp, self.experiences.size) # Change Python 3 - Paulo
