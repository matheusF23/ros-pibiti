...
from .local_view_match3 import LocalViewMatch  # Change Python 3 - Paulo
from .posecellnetwork3 import PoseCellNetwork  # Change Python 3 - Paulo
from .visual_odometry3 import VisualOdometry # Change Python 3 - Paulo
from .experience_map3 import ExperienceMap  # Change Python 3 - Paulo
from ._globals3 import * # Change Python 3 - Paulo
...
class Ratslam(object):
    def __init__(self):
        ...
        '''
        self.visual_odometry  = VisualOdometry() # Change Python 3 - Paulo
        self.visual_templates = LocalViewMatch() # Change Python 3 - Paulo
        self.network          = PoseCellNetwork() # Change Python 3 - Paulo
        self.map              = ExperienceMap() # Change Python 3 - Paulo
    ...
    def __call__(self, img, greyscale):
        ...
        # self.vtrans, self.vrot           = self.pool.starmap(self.visual_odometry, (img, greyscale))
        self.vtrans, self.vrot           = self.visual_odometry(img, greyscale)
        ...
        action, matched_exp_id = self.network( current_vt, vt_rad, self.vtrans, self.vrot, self.time_diff )
        ...
        # relaxation
        self.map.on_odo( self.vtrans, self.vrot, self.time_diff )
