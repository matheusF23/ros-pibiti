...
class LocalViewMatch(object):
    ...
    def __convert_view_to_view_template__(self, grayscale):
        ...
        if grayscale:
            ...
            x_block_count = 0
            data_next = 0
            for y_block in range(IMAGE_VT_Y_RANGE_MIN, IMAGE_VT_Y_RANGE_MAX, y_block_size):
                for x_block in range(IMAGE_VT_X_RANGE_MIN, IMAGE_VT_X_RANGE_MAX, x_block_size):
    ...
    def save(self):
        ...
        Outputs: -
        '''
        with open('./Save/localviewcells.txt', 'w') as file:
    ...
    def load(self):
        ...
        Outputs: -
        '''
        with open('./Save/localviewcells.txt', 'r') as file:
